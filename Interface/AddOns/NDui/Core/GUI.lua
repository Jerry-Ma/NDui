...
local defaultSettings = {
	...
	Mover = {},
    UI = {
        -- parent padding levels
        WorldDivX = {0, 7},
        WorldDivY = {0, 28},
        ActionBarFramePadding = 1,
        ActionBarButtonMargin = 2,
        UFHealthTextFS = {11, 10, 10, 10}, -- (player, focus, boss, pet)
        UFPowerTextFS = {11, 10, 10, 10},
        UFIconSize = {8, },  -- UF indicators
        HideBlizRaidFrame=true,
    },
	InternalCD = {},
	AuraWatchMover = {},
	RaidClickSets = {},
...
local optionList = { -- type, key, value, name, horizon, doubleline
	[1] = {
		...
		{4, "Actionbar", "Style", L["Actionbar Style"], false, {L["BarStyle1"], L["BarStyle2"], L["BarStyle3"], L["BarStyle4"], L["BarStyle5"], L["BarStyle6"]}},
